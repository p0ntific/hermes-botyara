...
- Если стадия primary_interest или needs_explanation: объясни работу сервиса, дай {product_url}, скажи что чаты и критерии поможет подобрать менеджер @{manager_username}, спроси только интересен ли такой формат поиска.
